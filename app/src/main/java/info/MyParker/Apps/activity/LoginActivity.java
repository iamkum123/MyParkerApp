...
import info.MyParker.Apps.officer.OfficerLoginActivity;
...
import info.MyParker.Apps.officer.OfficerMainActivity;

public class LoginActivity extends Activity {
    private static final String TAG = RegisterActivity.class.getSimpleName();
    private Button btnLogin;
    private Button btnLinkToRegister;
    private Button goofficer;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        goofficer=(Button)findViewById(R.id.toofficer);
        ...
        goofficer.setOnClickListener(new View.OnClickListener() {

            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(),
                        OfficerLoginActivity.class);
                startActivity(i);
                finish();
            }
        });
